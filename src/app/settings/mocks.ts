...
import { DEFAULT_AGENT_CONTEXT, DEFAULT_NOTIFY, DEFAULT_SECURITY, DEFAULT_TERM, DEFAULT_WT_DEFAULTS } from "./provision";

export const MOCK: Settings = {
  version: 1, editor: { command: "code" }, terminal: "Terminal", showSwitchBranch: true, pinnedWorktrees: [], security: DEFAULT_SECURITY, notifications: DEFAULT_NOTIFY, embeddedTerminal: DEFAULT_TERM, experiments: {}, keybindings: {}, updates: { autoCheck: true }, crashReports: { enabled: false },
  repos: [{
